...
# =============================================================================
# # LCC vs CO2 (integrated)
# plt.figure(figsize=(10,5))
# DFName = 'CCHP+WWT'
# plt.scatter(x=DFs[DFName][26]/10**3,y=DFs[DFName][39], s=2)
# plt.xlabel(r'LCC (k\$/$m^2$)')
# plt.ylabel(r'Lifecycle $CO_{2e}$ (T/$m^2$)')
# plt.savefig('CO2_vs_LCC_Integ.png', dpi=400, bbox_inches='tight')
# 
# 
# # LCC vs CO2 (disintegrated)
# plt.figure(figsize=(10,5))
# DFName = 'CCHP|CWWTP'
# plt.scatter(x=DFs[DFName][26]/10**3,y=DFs[DFName][39], s=2)
# plt.xlabel(r'LCC (k\$/$m^2$)')
# plt.ylabel(r'Lifecycle $CO_{2e}$ (T/$m^2$)')
# plt.savefig('CO2_vs_LCC_Disinteg.png', dpi=400, bbox_inches='tight')
# =============================================================================
